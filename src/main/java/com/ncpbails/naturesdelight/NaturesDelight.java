package com.ncpbails.naturesdelight;
...
public class NaturesDelight
{
    ...
    public static class ClientModEvents
    {
        ...
        {
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.WILD_PINEAPPLE.get(), RenderType.cutoutMipped());
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.PINEAPPLES.get(), RenderType.cutoutMipped());
        }
    }
}
